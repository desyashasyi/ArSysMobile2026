...
class FinalDefenseRepository {
  ...
  Future<void> submitExaminerScore(int presenceId, int score, String? remark) async {
    final response = await _authService.post(
      '/staff/final-defense/presence/$presenceId/score',
      {
        'score': score,
        'remark': remark,
      },
  ...
  Future<void> submitSupervisorScore(int supervisorId, int score, String? remark) async {
    final response = await _authService.post(
      '/staff/final-defense/supervisor/$supervisorId/score',
      {
        'score': score,
        'remark': remark,
      },
