...
class View extends Component
{
    ...
    protected $listeners = ['refreshView_ArSysSpecializationEventApplicant_FinalDefense' => '$refresh'];
    public function render()
    {
        ...
        $eventApplicants =  EventApplicantFinalDefense::where('event_id', $this->eventId)
                ...
                //->orderBy('room_id', 'ASC')
                ->paginate($perPage = 15, $columns = ['*'], $pageName = 'finaldefenseApplicant');
                //->get();
                //dd($eventApplicants);
        ...
        return view('livewire.specialization.event.final-defense.view', [
    ...
    public function confirm($applicantId){
        /*if(EventApplicantFinalDefense::find($applicantId)->confirmed == null){
            EventApplicantFinalDefense::find($applicantId)->update([
                'confirmed' => 1,
            ]);
        }else{
            EventApplicantFinalDefense::find($applicantId)->update([
