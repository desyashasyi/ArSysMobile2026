...
class Page extends Component
{
    ...
    public function render()
    {
        $events = Event::where('status', 1)->where('event_date', '>=', Carbon::today()->subDay(90))
            ...
            ->whereHas('seminarApplicantPublish', function($query){
            ...
            ->paginate($perPage = 5, $columns = ['*'], $pageName = 'eventOfSeminar');
        ...
        return view('livewire.staff.event.seminar.page', ['events' => $events]);
    }
