            ...
            <div x-show="addSpecialization">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-left">
                            <div class="col-md-8">
                                <x-adminlte-input placeholder="Head of specialization" value="responsibleNameCreate" wire:model="responsibleNameCreate" name="responsibleNameCreate" label="Responsible staff" style="width: 100%" disabled/>
                        ...
                        <div class="row text-left">
                            <div class="col-md-3">
                                <x-adminlte-button   wire:click="saveSpecialization_ArSysAdminConfigInstitutionPage"
