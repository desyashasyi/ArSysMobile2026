<div>
    <div wire:ignore.self wire:key='"arsys-admin-user-components-staff-edit'>
        <div class="card">
            <div class="card-body" >
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <x-adminlte-select2 label="Specialization" style="width: 100%" wire:model="specialization" id="specializationEdit" name="specializationEdit">
                                    ...
                                    @foreach ($specializations as $index => $specialization)
                                        <option value="{{$specialization->id}}"><b>{{$specialization->data->code}}</b>-{{$specialization->data->description}}</option>
                                    @endforeach
                                </x-adminlte-select2>
                ...
                <div class="row">
                    <div class="col-md-12 text-left">
                        <x-adminlte-button   wire:click="update" theme="success" icon="fa fa-save" class="btn btn-sm" label="Update"/>
                    </div>
                </div>
            </div>
        </div>  
