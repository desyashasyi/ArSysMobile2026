<div>
    <div wire:key="arsys.student.research.components.supervise-meeting">
        <div wire:ignore.self class="modal fade" id="superviseMeetingModal_Staff" tabindex="-1" role="dialog" aria-labelledby="reviewSetReviewerModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-md" role="document">
               <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="superviseMeetingModal_Staff">Supervise Meeting</h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            @if($discussion->discussant_id == Auth::user()->id)
                                                                <i wire:click="delete({{$discussion->id}})" style="color:red;cursor: pointer;" class="fa fa-times-circle fa-sm"></i>
                                                            @endif
                                                            <br>
                                                            {!!$discussion->message!!}
                                                        </div>
    ...
    @push('scripts')
        <script>
            window.livewire.on('superviseMeetingModal_ArSysStaffResearchSuperviseMeeting', () => {
                $('#superviseMeetingModal_Staff').modal('show');
            });
            ...
            window.livewire.on('setSummernoteMessageStaffSuperviseMeeting', () => {
