                                ...
                                @if($remarks)
                                    ...
                                    @if(count($remarks) >=3)
                                        <div x-data="{showMore : @entangle('showMore') }">
                                            <div x-show="!showMore">
                                                <u style="cursor:pointer; color:green" wire:click="showMore">Show less/more</u>
                                            </div>
                                            <div x-show="showMore">
                                                <u style="cursor:pointer; color:red" wire:click="showMore">Show less/more</u>
                                            </div>
                                        </div>   
                                    @endif
                                @endif   
