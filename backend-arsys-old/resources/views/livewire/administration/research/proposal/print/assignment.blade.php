...
<body>
    ...
    @foreach ($research->supervisor as $index => $supervisor)
        ...
        <div id="bodysurat">
            <table width="100%">
                <tbody>
                    ...
                    <tr align="center">
                        <td width="5%">No: {{$research->spvLetter->faculty_letter_number}}{{$research->spvLetter->faculty->number}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align: justify">
                            Memperhatikan Surat Ketua Prodi {{$research->student->program->name}} {{$research->student->program->faculty->code}} UPI
                            Nomor: {{$research->spvLetter->program_letter_number}}{{$research->spvLetter->program->number}} tentang usulan Penunjukkan Dosen 
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: justify">
                            ...
                            dan berlaku terhitung mulai tanggal dikeluarkannya sampai ({{$research->spvLetter->expire_date_back}}).
                        </td>
                    </tr>
            ...
            <table width="100%">
                <tbody>
                   <tr>
                    ...
                    <td>
                        Bandung,  {{$research->spvLetter->faculty_letter_date_back}}
                        <br>
                        a.n. Dekan {{$research->student->program->faculty->code}}
                        <br>
        ...
        @if($index < $research->supervisor->count()-1)
