<div>
                    ...
                    <div class="row">
                        <div class="text-left col-md-12">
                            @if($remarks)
                                ...
                                @endforeach
                                <div x-data="{showMore : @entangle('showMore') }">
                                    <div x-show="!showMore">
                                        <u style="cursor:pointer; color:green" wire:click="showMore">Show more</u>
                                    </div>
                                    <div x-show="showMore">
                                        <u style="cursor:pointer; color:red" wire:click="showMore">Show less</u>
                                    </div>
                                </div> 
                            @endif   
                        </div>
    ...
    <script>
        ...
        window.addEventListener('setSummernoteMessageSpecializationRemark', event => {
