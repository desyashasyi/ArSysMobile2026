                                            ...
                                            @foreach($rooms as $room)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif
                                                        <hr>
                                                        <span style="cursor: pointer; color:green" wire:click="$emit('session_ArSysSpecializationEventApplicant', {{$room->id}}, 'Seminar')">
                ...
                <div class="col-md-12 offset-sm-0">
                    @if($event->finaldefenseApplicant->contains('publish', null))
                        <span style="color:red">
                           Thera are {{$event->finaldefenseApplicant->where('publish', null)->count()}} applicant need to be published. Please re-publish the schedule.
                        </span>
                    @endif
                </div>
            </div>
