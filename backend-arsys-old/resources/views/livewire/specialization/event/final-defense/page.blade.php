                                ...
                                @endif
                                    ...
                                    <td class="text-right">
                                        ...
                                        @if($event->finaldefenseApplicantPublish)
                                           <livewire:specialization.event.final-defense.schedule :eventId="$event->id" :wire:key="'schedule-'.$event->id">
                                        @endif
                                        ...
                                        <td colspan="7">
                                            <div x-data="{viewEvent : @entangle('viewEvent') }">
                                                <div x-show="viewEvent">
                                                    <livewire:specialization.event.final-defense.view :eventId="$event->id" :wire:key="'view-'.$event->id">
                                                </div>
                                            </div>
                                        </td>
                                        <td width="1%"></td>
