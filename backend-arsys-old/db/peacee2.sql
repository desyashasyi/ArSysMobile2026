...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8mb3 COMMENT='More data about journals, including localized properties like policies.';
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb3 COMMENT='More data about notifications, including localized properties.';
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb3 COMMENT='User notifications created during certain operations.';
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb3 COMMENT='More data about plugins, including localized properties. This table is frequently used to store plugin-specific configuration.';
...
-- ----------------------------
BEGIN;
INSERT INTO `scheduled_tasks` (`scheduled_task_id`, `class_name`, `last_run`) VALUES (1, 'PKP\\task\\ReviewReminder', '2024-10-26 11:23:50');
...
INSERT INTO `scheduled_tasks` (`scheduled_task_id`, `class_name`, `last_run`) VALUES (4, 'PKP\\task\\DepositDois', '2024-10-26 11:23:50');
...
INSERT INTO `scheduled_tasks` (`scheduled_task_id`, `class_name`, `last_run`) VALUES (8, 'APP\\tasks\\UsageStatsLoader', '2024-10-26 11:23:51');
INSERT INTO `scheduled_tasks` (`scheduled_task_id`, `class_name`, `last_run`) VALUES (9, 'PKP\\task\\ProcessQueueJobs', '2024-10-26 11:23:51');
INSERT INTO `scheduled_tasks` (`scheduled_task_id`, `class_name`, `last_run`) VALUES (10, 'PKP\\task\\RemoveFailedJobs', '2024-10-24 22:17:43');
INSERT INTO `scheduled_tasks` (`scheduled_task_id`, `class_name`, `last_run`) VALUES (11, 'APP\\tasks\\OpenAccessNotification', '2024-10-26 11:23:51');
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb3 COMMENT='Describes the installation and upgrade version history for the application and all installed plugins.';
